                ...
                <div class="card-body">
                    <form action="{{ route('invoice.update', $invoice->id) }}" method="post" class="form">
                                ...
                                <tr class="cloning_row" id="{{ $loop->index }}">
                                    ...
                                    <td>
                                        <select name="unit[{{ $loop->index }}]" id="unit" class="unit form-control">
                                            <option></option>
                                            <option value="piece" {{ $item->unit == 'piece' ? 'selected' : '' }}>@lang('site.piece')</option>
                                            <option value="g" {{ $item->unit == 'g' ? 'selected' : '' }}>@lang('site.gram')</option>
                                            <option value="kg" {{ $item->unit == 'kg' ? 'selected' : '' }}>@lang('site.kilo_gram')</option>
                                        </select>
                                    ...
                                    <td>
                                        <div class="input-group mb-3">
                                            <select name="discount_type" id="discount_type" class="discount_type custom-select">
                                                <option value="fixed" {{ $invoice->discount_type == 'fixed' ? 'selected' : '' }}>@lang('site.sr')</option>
                                                <option value="percentage" {{ $invoice->discount_type == 'percentage' ? 'selected' : '' }}>@lang('site.percentage')</option>
                                            </select>
                        ...
                        <div class="text-right pt-3">
                            <button type="submit" name="save" class="btn btn-primary">@lang('site.update')</button>
                        </div>
                    </form>
                </div>
            </div>
