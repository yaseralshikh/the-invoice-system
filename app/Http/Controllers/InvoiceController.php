...
class InvoiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($details) {
            return redirect()->back()->with([
                'message' => Lang::get('site.created_successfully'),//Lang::get('site.created_successfully'),
                'alert-type' => 'success'
            ]);
        } else {
            return redirect()->back()->with([
                'message' => Lang::get('site.created_failed'),//Lang::get('site.created_failed'),
                'alert-type' => 'danger'
            ]);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($details) {
            return redirect()->back()->with([
                'message' => Lang::get('site.updated_successfully'),
                'alert-type' => 'success'
            ]);
        } else {
            return redirect()->back()->with([
                'message' => Lang::get('site.updated_failed'),
                'alert-type' => 'danger'
            ]);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if ($invoice) {
            ...
            return redirect()->route('invoice.index')->with([
                'message' => Lang::get('site.deleted_successfully'),
                'alert-type' => 'success'
            ]);
        } else {
            return redirect()->route('invoice.index')->with([
                'message' => Lang::get('site.deleted_failed'),
                'alert-type' => 'danger'
            ]);
        }
    }
    ...
    public function pdf($id)
    {
        ...
        $data['customer']           = [
            Lang::get('site.customer_name')       => $invoice->customer_name,
            Lang::get('site.customer_mobile')     => $invoice->customer_mobile,
            Lang::get('site.customer_email')      => $invoice->customer_email
        ];
        $items = [];
    ...
    public function send_to_email($id)
    {
        ...
        return redirect()->route('invoice.index')->with([
            'message' => Lang::get('site.sent_successfully'),
            'alert-type' => 'success'
        ]);
